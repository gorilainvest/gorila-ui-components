(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/material/card'), require('@angular/material/expansion'), require('@angular/material/grid-list'), require('@angular/material/input'), require('@angular/material/list'), require('@angular/material/select'), require('@angular/material/core'), require('@angular/forms'), require('ramda')) :
    typeof define === 'function' && define.amd ? define('@gorilainvest/gdk', ['exports', '@angular/core', '@angular/common', '@angular/material/card', '@angular/material/expansion', '@angular/material/grid-list', '@angular/material/input', '@angular/material/list', '@angular/material/select', '@angular/material/core', '@angular/forms', 'ramda'], factory) :
    (global = global || self, factory((global.gorilainvest = global.gorilainvest || {}, global.gorilainvest.gdk = {}), global.ng.core, global.ng.common, global.ng.material.card, global.ng.material.expansion, global.ng.material['grid-list'], global.ng.material.input, global.ng.material.list, global.ng.material.select, global.ng.material.core, global.ng.forms, global.ramda));
}(this, function (exports, core, common, card, expansion, gridList, input, list, select, core$1, forms, ramda) { 'use strict';
    ...
    var GdkCardComponent = /** @class */ (function () {
        ...
        GdkCardComponent.propDecorators = {
            ...
            withoutInput: [{ type: core.Input }],
            withoutOutput: [{ type: core.Input }]
        };
    ...
    var GdkImportComponent = /** @class */ (function () {
        ...
        Object.defineProperty(GdkImportComponent.prototype, "form", {
            ...
            function (form) {
                var _this = this;
                this.keys = ramda.keys(form.controls);
    ...
    exports.GdkModule = GdkModule;
    exports.ɵa = GdkCardComponent;
    exports.ɵb = GdkImportComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=gorilainvest-gdk.umd.js.map
